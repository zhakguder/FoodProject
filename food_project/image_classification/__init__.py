...
def compile_test_images_from_recipe_ingredients(n_recipes, recipe_label_path, ind_image_size=200):
    '''Args:
    ...
    return ril.get_recipe_ingredient_images(n_recipes,ind_image_size)
