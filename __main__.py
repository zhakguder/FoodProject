...
# populate_db_recipes('data/recipes/raw/ArgentinianRecipes')
# populate_db_images('data/recipes/raw/ArgentinianRecipes')
# populate_db_processed('data/recipes/processed/ArgentinianRecipes')
